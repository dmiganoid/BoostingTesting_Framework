...
def train_test_model(algorithm_class, params, X_train, X_test, y_train, y_test, results_path, ind=""):
    ...
    def fit_and_evaluate(self, X, y, random_state=42, test_size=0.15, results_path="results", test_name="test"):
        ...
        for algorithm_class, algorithm_param_grid in self.algorithms:
            ...
            for ind, params in enumerate(ParameterGrid(algorithm_param_grid)):
                threads.append(pool.apply_async(train_test_model, args=[algorithm_class, params, X_train, X_test, y_train, y_test, f'{results_path}/{test_name}'], kwds={"ind" : ind}))
